...
- 18 unit/component tests cover the execution path on Python 3.13.7 with Web3.py 7.16.0, including refusal to start a duplicate order worker, stale data and external wallet changes.
- GitHub Actions also passed the initial 15-test build on Linux/Python 3.12. The workflow reruns for every published update.
